...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.characterSelect = function (index) {
        var _this = this;
        this.resetData();
        this.loading = true;
        this.selected = this.characters[index].name;
        this.appService.getCharacterData(this.characters[index].url)
            .subscribe(function (data) { return _this.callFilms(data); }, function (err) { return _this.errorHandler(err); });
    };
    ...
    AppComponent.prototype.callFilms = function (data) {
        var _this = this;
        this.loading = false;
        this.films = data.films;
        this.appService.getFilmData(this.films)
            .subscribe(function (res) { return _this.filmHandler(res); }, function (err) { return _this.errorHandler(err); });
    };
    AppComponent.prototype.filmHandler = function (data) {
        this.details = data;
    };
    AppComponent.prototype.errorHandler = function (data) {
        this.details = [];
        this.loading = false;
        this.error = true;
    };
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.getCharacterData = function (url) {
        return this.http.get(url);
    };
    AppService.prototype.getFilmData = function (films) {
        var e_1, _a;
        var callArray = [];
        try {
            for (var films_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](films), films_1_1 = films_1.next(); !films_1_1.done; films_1_1 = films_1.next()) {
                var film = films_1_1.value;
            ...
            try {
                if (films_1_1 && !films_1_1.done && (_a = films_1.return)) _a.call(films_1);
            }
